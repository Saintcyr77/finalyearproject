...
public class SortingVisualizer {
    ...
    public static VisualizerFrame2 frame2;
    ...
    public static void startSort(String type){
        ...
        if (sortingThread == null || !isSorting){
            ...
            switch(type){
                ...
                case "Cyclic":
                    sortingThread = new Thread(new CyclicSort(toBeSorted, frame, false));
                    break;
